...
const FILTERS: Record<VisionFilter, FilterDef> = {
  ...
  blurred:       { label: 'Blurred vision',       prevalence: '22.9% of users', ball: ['#fb923c', '#818cf8'], blur: true },
  deuteranomaly: { label: 'Deuteranomaly',        prevalence: '2.7% of users',  ball: ['#a78040', '#607860'],
    matrix: '0.8 0.2 0 0 0  0.258 0.742 0 0 0  0 0.142 0.858 0 0  0 0 0 1 0' },
  deuteranopia:  { label: 'Deuteranopia',         prevalence: '0.56% of users', ball: ['#8a6a30', '#4a6a4a'],
    matrix: '0.625 0.375 0 0 0  0.7 0.3 0 0 0  0 0.3 0.7 0 0  0 0 0 1 0' },
  protanomaly:   { label: 'Protanomaly',          prevalence: '0.66% of users', ball: ['#6060a0', '#508050'],
    matrix: '0.817 0.183 0 0 0  0.333 0.667 0 0 0  0 0.125 0.875 0 0  0 0 0 1 0' },
  protanopia:    { label: 'Protanopia',           prevalence: '0.59% of users', ball: ['#4a4a88', '#406840'],
    matrix: '0.567 0.433 0 0 0  0.558 0.442 0 0 0  0 0.242 0.758 0 0  0 0 0 1 0' },
  tritanomaly:   { label: 'Tritanomaly',          prevalence: '0.01% of users', ball: ['#e05050', '#5050c8'],
    matrix: '0.967 0.033 0 0 0  0 0.733 0.267 0 0  0 0.183 0.817 0 0  0 0 0 1 0' },
  tritanopia:    { label: 'Tritanopia',           prevalence: '0.016% of users', ball: ['#cc2222', '#2222cc'],
    matrix: '0.95 0.05 0 0 0  0 0.433 0.567 0 0  0 0.475 0.525 0 0  0 0 0 1 0' },
  achromatopsia: { label: 'Achromatopsia',        prevalence: '0.0001% of users', ball: ['#888', '#ccc'],
    matrix: '0.299 0.587 0.114 0 0  0.299 0.587 0.114 0 0  0.299 0.587 0.114 0 0  0 0 0 1 0' },
  grayscale:     { label: 'Grayscale',            prevalence: '',               ball: ['#666', '#aaa'],
    matrix: '0.299 0.587 0.114 0 0  0.299 0.587 0.114 0 0  0.299 0.587 0.114 0 0  0 0 0 1 0' },
}
...
function ColorBall({ filter, size = 20 }: { filter: VisionFilter; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" style={{ flexShrink: 0, ...(def.blur ? { filter: 'blur(1.5px)' } : {}) }}>
      <defs>
                ...
                >
                  {isReset ? (
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ flexShrink: 0 }}>
                      <path d="M10 4a6 6 0 1 0 5.66 4H14a4 4 0 1 1-4-4V2l3 3-3 3V6a6 6 0 0 0-6 6" stroke="#6b7280" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M10 4V2l3 3-3 3" stroke="#6b7280" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ) : (
                    <ColorBall filter={key} size={20} />
                  )}
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 500, color: isSelected ? '#a5b4fc' : '#c4c4d4' }}>
                      {def.label}
                    </div>
                    {def.prevalence && (
