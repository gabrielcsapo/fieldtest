...
var re = class {
    ...
    delete(e, t) {
      if (this.size !== 0) {
        this.#e = this.#e.filter((e) => e[1] !== t);
        for (let [n, r] of this.#t) n === e && r.includes(t) && r.splice(r.indexOf(t), 1);
      }
    }
    deleteAll(e) {
      this.size !== 0 && ((this.#e = this.#e.filter((t) => t[0] !== e)), this.#t.delete(e));
    }
    get size() {
  ...
  d = Symbol(`kDefaultPrevented`),
  f = Symbol(`kPropagationStopped`),
  p = Symbol(`kImmediatePropagationStopped`),
  m = class extends MessageEvent {
    [d];
    [f];
    [p];
    constructor(...e) {
      (super(e[0], e[1]), (this[d] = !1));
    }
    get defaultPrevented() {
      return this[d];
    }
    preventDefault() {
      (super.preventDefault(), (this[d] = !0));
    }
    stopImmediatePropagation() {
      (super.stopImmediatePropagation(), (this[p] = !0));
    }
  },
  ie = Symbol(`kListenerOptions`),
  ae = class {
    #e;
    constructor() {
      this.#e = new re();
    ...
    on(e, t, n) {
      return (this.#t(e, t, n), this);
    }
    once(e, t, n) {
      return this.on(e, t, { ...(n || {}), once: !0 });
    }
    earlyOn(e, t, n) {
      return (this.#t(e, t, n, `prepend`), this);
    }
    earlyOnce(e, t, n) {
    ...
    emit(e) {
      ...
      let t = this.listenerCount(e.type) > 0,
        n = this.#n(e);
      for (let t of this.#i(e.type)) {
        if (n.event[f] != null && n.event[f] !== this) return (n.revoke(), !1);
        if (n.event[p]) break;
        this.#r(n.event, t);
      }
      return (n.revoke(), t);
    ...
    async emitAsPromise(e) {
      ...
      let t = [],
        n = this.#n(e);
      for (let r of this.#i(e.type)) {
        if (n.event[f] != null && n.event[f] !== this) return (n.revoke(), []);
        if (n.event[p]) break;
        let e = await Promise.resolve(this.#r(n.event, r));
        this.#a(r) || t.push(e);
      }
      return (
        n.revoke(),
    ...
    *emitAsGenerator(e) {
      if (this.#e.size === 0) return;
      let t = this.#n(e);
      for (let n of this.#i(e.type)) {
        if (t.event[f] != null && t.event[f] !== this) {
          t.revoke();
          return;
        }
        if (t.event[p]) break;
        let e = this.#r(t.event, n);
        this.#a(n) || (yield e);
      }
      t.revoke();
    }
    ...
    #t(e, t, n, r = `append`) {
      (r === `prepend` ? this.#e.prepend(e, t) : this.#e.append(e, t),
        n &&
          (Object.defineProperty(t, ie, { value: n, enumerable: !1, writable: !1 }),
          n.signal &&
    ...
    #n(e) {
      ...
      return (
        (e.stopPropagation = new Proxy(e.stopPropagation, {
          apply: (t, n, r) => ((e[f] = this), Reflect.apply(t, n, r)),
        })),
        {
          event: e,
          revoke() {
    ...
    #r(e, t) {
      let n = t.call(this, e);
      if (t[ie]?.once) {
        let n = this.#a(t) ? `*` : e.type;
        this.#e.delete(n, t);
      }
      return n;
    }
    *#i(e) {
      for (let [t, n] of this.#e) (t === `*` || t === e) && (yield n);
    }
    #a(e) {
      return this.#e.get(`*`).includes(e);
    }
  };
function oe(e) {
  let t = {};
  for (let n of e) (t[n.kind] ||= []).push(n);
  return t;
}
var se = class {
    getInitialState(t) {
      ...
      let n = oe(t);
      return { initialHandlers: n, handlers: { ...n } };
    }
    currentHandlers() {
    ...
    use(t) {
      if (
        ...
        return;
      let { handlers: n } = this.getState();
      for (let e = t.length - 1; e >= 0; e--) {
        let r = t[e];
        n[r.kind] = n[r.kind] ? [r, ...n[r.kind]] : [r];
      }
      this.setState({ handlers: n });
    }
    reset(t) {
      e(
        t.length > 0 ? this.#e(t) : !0,
        a.formatMessage(
          `Failed to replace initial handlers during reset: invalid handlers. Did you forget to spread the handlers array?`,
        ),
      );
      let { initialHandlers: n } = this.getState();
      if (t.length === 0) {
        this.setState({ handlers: { ...n } });
        return;
      }
      let r = oe(t);
      this.setState({ initialHandlers: r, handlers: { ...r } });
    }
    #e(e) {
  ...
  ce = class extends se {
    ...
    setState(e) {
      (e.initialHandlers && (this.#t = e.initialHandlers), e.handlers && (this.#e = e.handlers));
    }
  };
function le(e) {
  let t = [...e];
...
async function fe(e, t) {
  let n = Reflect.get(t, u);
  n && (await te.setCookie(n, e.url));
}
function pe(e) {
  let t = [];
...
var h = ((e) => ((e[(e.DISABLED = 0)] = `DISABLED`), (e[(e.ENABLED = 1)] = `ENABLED`), e))(h || {});
function me(t) {
  let n = 0,
    r = new ae(),
    i = (e) => (e instanceof se ? e : new ce(e || [])),
    a = { ...t },
    o = i(a.handlers),
    s;
  return {
    ...
    configure(t) {
      (e(n === 0, ``),
        t.handlers && !Object.is(t.handlers, a.handlers) && (o = i(t.handlers)),
        (a = { ...a, ...t }));
    },
    enable() {
      return (
        e(n === 0, `Failed to call "enable" on the network: already enabled`),
        (s = new AbortController()),
        (n = 1),
        pe(
          a.sources.map(
            (e) => (
              e.on(`frame`, async ({ frame: e }) => {
                e.events.on(`*`, (e) => r.emit(e), { signal: s.signal });
                let t = e.getHandlers(o);
                await e.resolve(t, a.onUnhandledFrame || `warn`, a.context);
              }),
              e.enable()
            ),
          ),
    ...
    disable() {
      return (
        e(n === 1, `Failed to call "disable" on the network: already disabled`),
        s.abort(),
        (n = 0),
        pe(a.sources.map((e) => e.disable()))
      );
    },
    use(...e) {
      o.use(e);
    ...
    restoreHandlers() {
      for (let e of o.currentHandlers()) `isUsed` in e && (e.isUsed = !1);
    },
    listHandlers() {
      return le(o.currentHandlers());
    },
  };
}
var he = class extends m {
  ...
  ge = class {
    ...
    async queue(e) {
      await this.emitter.emitAsPromise(new he(`frame`, e));
    }
    on(e, t, n) {
  ...
  _e = class {
    constructor(e, t) {
      ((this.protocol = e), (this.data = t), (this.events = new ae()));
    }
    events;
  };
function ve(e) {
...
async function g(t, n) {
  let r = async (e) => {
      if (e === `bypass`) return;
      let n = await t.getUnhandledMessage();
      switch (e) {
        case `warn`:
          return a.warn(`Warning: %s`, n);
        case `error`:
          return a.error(`Error: %s`, n);
      }
    },
    i = async (t) => {
      if (
  ...
  if (typeof n == `function`)
    return n({ frame: t, defaults: { warn: r.bind(null, `warn`), error: r.bind(null, `error`) } });
  if (!(t instanceof v && ne(t.data.request))) return i(n);
}
  ...
  v = class extends _e {
    ...
    async getUnhandledMessage() {
      let { request: e } = this.data,
        t = new URL(e.url),
        r = n(t) + t.search,
        i = e.body == null ? null : await e.clone().text();
...
Read more: https://mswjs.io/docs/http/intercepting-requests`;
    ...
    async resolve(e, t, n) {
      let { id: r, request: i } = this.data,
        o = n?.quiet ? null : i.clone();
      if ((this.events.emit(new _(`request:start`, { requestId: r, request: i })), ve(i)))
        return (
          this.events.emit(new _(`request:end`, { requestId: r, request: i })),
          this.passthrough(),
          null
        );
      let [s, c] = await de(() =>
        l({
          ...
          request: i,
          handlers: e,
          resolutionContext: { baseUrl: n?.baseUrl?.toString(), quiet: n?.quiet },
        }),
      );
      if (s != null)
        return (
          this.events.emit(new Se(`unhandledException`, { error: s, requestId: r, request: i })) ||
            (console.error(s),
            a.error(
      ...
      if (c == null)
        return (
          this.events.emit(new _(`request:unhandled`, { requestId: r, request: i })),
          await g(this, t).then(
            () => this.passthrough(),
            (e) => this.errorWith(e),
          ),
      ...
      let { response: u, handler: ee, parsedResult: te } = c;
      return (
        this.events.emit(new _(`request:match`, { requestId: r, request: i })),
        u == null || ye(u)
          ? (this.events.emit(new _(`request:end`, { requestId: r, request: i })),
            this.passthrough(),
            null)
          : (await fe(i, u),
            this.respondWith(u.clone()),
            this.events.emit(new _(`request:end`, { requestId: r, request: i })),
            n?.quiet || ee.log({ request: o, response: u, parsedResult: te }),
            !0)
      );
    }
  },
  ...
  Te = class extends _e {
    ...
    async resolve(e, t, n) {
      ...
      if (
        (this.events.emit(new Ce(`connection`, { url: r.client.url, protocols: r.info.protocols })),
        e.length === 0)
      )
        return (
          await g(this, t).then(
      ...
      let i = !1;
      for (let t of e) {
        let e = await t.run(r, { baseUrl: n?.baseUrl?.toString(), [ee]: !1 });
        if (!e) continue;
        i = !0;
        let o = n?.quiet ? void 0 : t.log(r);
        try {
          t[s](e) || o?.();
        } catch (e) {
          throw (
            this.events.emit(
              new we(`unhandledException`, {
                error: e,
                url: r.client.url,
...
Read more: https://mswjs.io/docs/websocket`;
  ...
  Ee = class extends ge {
    ...
    constructor(e) {
      (super(),
        (this.#e = new r({ name: `interceptor-source`, interceptors: e.interceptors })),
        (this.#t = new Map()));
    }
    enable() {
      (this.#e.apply(),
    ...
    async #n({ requestId: e, request: t, controller: n }) {
      let r = new De({ id: e, request: t, controller: n });
      (this.#t.set(e, r), await this.queue(r));
    }
    async #r({ requestId: e, request: t, response: n, isMockedResponse: r }) {
      let i = this.#t.get(e);
      (this.#t.delete(e),
        i != null &&
          queueMicrotask(() => {
            i.events.emit(
              new xe(r ? `response:mocked` : `response:bypass`, {
                requestId: e,
                request: t,
                response: n,
              }),
    ...
    async #i(e) {
      await this.queue(new Oe({ connection: e }));
    }
  },
  De = class extends v {
    #e;
    ...
    errorWith(e) {
      ...
      throw (e instanceof o && this.#e.errorWith(e), e);
    }
  },
  Oe = class extends Te {
    constructor(e) {
    ...
    errorWith(e) {
      if (e instanceof Error) {
        let { client: t } = this.data.connection,
          n = new Event(`error`);
        (Object.defineProperty(n, `cause`, { enumerable: !0, configurable: !1, value: e }),
      ...
      if (typeof i == `function`) {
        let t =
          n instanceof v
            ? n.data.request
            : n instanceof Te
              ? new Request(n.data.connection.client.url, {
        ...
        return (
          ...
          i(t, { warning: r.warn, error: r.error })
        );
      }
      return g(n, i);
    }
...
var Fe = class extends Error {
  ...
  b = (e, t, ...n) => {
    if (!e) throw new Fe(t, ...n);
  };
b.as = (e, t, n, ...r) => {
  if (!t) {
    let t = r.length === 0 ? n : y(n, ...r),
      i;
    try {
...
var Ie = Object.defineProperty,
  ...
  Re = {};
Le(Re, { blue: () => Be, gray: () => Ve, green: () => Ue, red: () => He, yellow: () => ze });
function ze(e) {
  ...
  We = class {
    constructor(e) {
      ...
      t === `1` || t === `true` || (t !== void 0 && this.name.startsWith(t))
        ? ((this.debug = w(n, `debug`) ? C : this.debug),
          (this.info = w(n, `info`) ? C : this.info),
          (this.success = w(n, `success`) ? C : this.success),
          (this.warning = w(n, `warning`) ? C : this.warning),
          (this.error = w(n, `error`) ? C : this.error))
        : ((this.info = C),
          (this.success = C),
          (this.warning = C),
          (this.error = C),
    ...
    logEntry(e) {
      let { level: t, message: n, prefix: r, colors: i, positionals: a = [] } = e,
        ...
        s = i?.timestamp || `gray`,
        c = i?.prefix || `gray`,
        l = { timestamp: Re[s], prefix: Re[c] };
      this.getWriter(t)(
        [l.timestamp(this.formatTimestamp(o.timestamp))]
          .concat(r == null ? [] : l.prefix(r), Xe(n))
          .join(` `),
        ...a.map(Xe),
      );
    }
...
function Ye(e) {
  return S ? {}[e] : globalThis[e]?.toString();
}
function w(e, t) {
  return e !== void 0 && e !== t;
}
  ...
  Qe = class {
    ...
    addListener(e, t) {
      ...
      if (
        ...
        let t = new Ze(this, e, this.listenerCount(e));
        console.warn(t);
      }
      return this;
    }
...
var et = `x-interceptors-internal-request-id`;
function tt(e) {
...
var T = (function (e) {
  ...
  E = class {
    constructor(e) {
      ((this.symbol = e),
        (this.readyState = T.INACTIVE),
        (this.emitter = new $e()),
        (this.subscriptions = []),
        (this.logger = new We(e.description)),
    ...
    apply() {
      ...
      if ((e.info(`applying the interceptor...`), this.readyState === T.APPLIED)) {
    ...
    on(e, t) {
      ...
      return this.readyState === T.DISPOSING || this.readyState === T.DISPOSED
    ...
    dispose() {
      ...
      if (
        (this.clearInstance(),
        e.info(`global symbol deleted:`, tt(this.symbol)),
      ...
      (this.emitter.removeAllListeners(),
        ...
        (this.readyState = T.DISPOSED));
    }
    getInstance() {
      let e = tt(this.symbol);
      return (this.logger.info(`retrieved global instance:`, e?.constructor?.name), e);
    }
    setInstance() {
      (nt(this.symbol, this), this.logger.info(`set global instance!`, this.symbol.description));
    }
    clearInstance() {
      (rt(this.symbol), this.logger.info(`cleared global instance!`, this.symbol.description));
    }
  };
function D() {
...
function it(e) {
  if (typeof e == `string`) return it(new URL(e, typeof location < `u` ? location.href : void 0));
  if (
    (e.protocol === `http:`
      ? (e.protocol = `ws:`)
...
function k(e) {
  ...
  return t === void 0 ||
    (typeof t.get == `function` && t.get() === void 0) ||
    (t.get === void 0 && t.value == null)
    ? !1
    : t.set === void 0 && !t.configurable
      ? (console.error(
...
var M = Symbol(`kCancelable`),
  N = Symbol(`kDefaultPrevented`),
  P = class extends MessageEvent {
    constructor(e, t) {
      (super(e, t), (this[M] = !!t.cancelable), (this[N] = !1));
    }
    get cancelable() {
      return this[M];
    }
    ...
    preventDefault() {
      this.cancelable && !this[N] && (this[N] = !0);
    }
  },
    ...
    constructor(e, t) {
      ((this.socket = e),
        ...
        this.transport.addEventListener(`outgoing`, (e) => {
          let t = j(
            this.socket,
            new P(`message`, { data: e.data, origin: e.origin, cancelable: !0 }),
          );
          (this[I].dispatchEvent(t), t.defaultPrevented && e.preventDefault());
        }),
        this.transport.addEventListener(`close`, (e) => {
          this[I].dispatchEvent(j(this.socket, new F(`close`, e)));
        }));
    }
    addEventListener(e, t, n) {
      if (!Reflect.has(t, L)) {
        let e = t.bind(this.socket);
        Object.defineProperty(t, L, { value: e, enumerable: !1, configurable: !1 });
      }
      this[I].addEventListener(e, Reflect.get(t, L), n);
    }
    removeEventListener(e, t, n) {
      this[I].removeEventListener(e, Reflect.get(t, L), n);
    }
    send(e) {
  ...
  ct = `InvalidAccessError: close code out of user configurable range`,
  R = Symbol(`kPassthroughPromise`),
  lt = Symbol(`kOnSend`),
  z = Symbol(`kClose`),
  ut = class extends EventTarget {
    static {
      this.CONNECTING = 0;
    }
    static {
    ...
    constructor(e, t) {
      (super(),
        ...
        queueMicrotask(async () => {
          (await this[R]) ||
            ((this.protocol =
              typeof t == `string` ? t : Array.isArray(t) && t.length > 0 ? t[0] : ``),
            this.readyState === this.CONNECTING &&
              ((this.readyState = this.OPEN), this.dispatchEvent(j(this, new Event(`open`)))));
        }));
    }
    set onopen(e) {
    ...
    send(e) {
      ...
      this.readyState === this.CLOSING ||
        ...
        queueMicrotask(() => {
          ((this.bufferedAmount = 0), this[lt]?.(e));
        }));
    }
    close(e = 1e3, t) {
      (b(e, ct), b(e === 1e3 || (e >= 3e3 && e <= 4999), ct), this[z](e, t));
    }
    [z](e = 1e3, t, n = !0) {
      this.readyState === this.CLOSING ||
        this.readyState === this.CLOSED ||
        ...
        queueMicrotask(() => {
          ((this.readyState = this.CLOSED),
            this.dispatchEvent(j(this, new F(`close`, { code: e, reason: t, wasClean: n }))),
            (this._onopen = null),
            (this._onmessage = null),
            (this._onerror = null),
            (this._onclose = null));
...
var B = Symbol(`kEmitter`),
  ...
  pt = class {
    constructor(e, t, n) {
      ((this.client = e),
        ...
        (this[B] = new EventTarget()),
        (this.mockCloseController = new AbortController()),
        (this.realCloseController = new AbortController()),
        this.transport.addEventListener(`outgoing`, (e) => {
          this.realWebSocket !== void 0 &&
            queueMicrotask(() => {
              e.defaultPrevented || this[ft](e.data);
            });
        }),
    ...
    connect() {
      ...
      ((e.binaryType = this.client.binaryType),
        e.addEventListener(
          `open`,
          (e) => {
            this[B].dispatchEvent(j(this.realWebSocket, new Event(`open`, e)));
          },
          { once: !0 },
        ),
        e.addEventListener(`message`, (e) => {
          this.transport.dispatchEvent(
            j(this.realWebSocket, new MessageEvent(`incoming`, { data: e.data, origin: e.origin })),
          );
        }),
        ...
        e.addEventListener(`error`, () => {
          ...
          (this[B].dispatchEvent(t),
            t.defaultPrevented || this.client.dispatchEvent(j(this.client, new Event(`error`))));
        }),
    ...
    addEventListener(e, t, n) {
      if (!Reflect.has(t, V)) {
        ...
        Object.defineProperty(t, V, { value: e, enumerable: !1 });
      }
      this[B].addEventListener(e, Reflect.get(t, V), n);
    }
    removeEventListener(e, t, n) {
      this[B].removeEventListener(e, Reflect.get(t, V), n);
    }
    send(e) {
      this[ft](e);
    }
    ...
    close() {
      ...
      (b(
        ...
        !(e.readyState === WebSocket.CLOSING || e.readyState === WebSocket.CLOSED) &&
          (e.close(),
          queueMicrotask(() => {
            this[B].dispatchEvent(
              j(this.realWebSocket, new ot(`close`, { code: 1e3, cancelable: !0 })),
            );
          })));
    }
    handleIncomingMessage(e) {
      let t = j(e.target, new P(`message`, { data: e.data, origin: e.origin, cancelable: !0 }));
      (this[B].dispatchEvent(t),
        t.defaultPrevented ||
          this.client.dispatchEvent(
            j(this.client, new MessageEvent(`message`, { data: e.data, origin: e.origin })),
          ));
    }
    handleMockClose(e) {
    ...
    handleRealClose(e) {
      ...
      let t = j(
        this.realWebSocket,
        new ot(`close`, { code: e.code, reason: e.reason, wasClean: e.wasClean, cancelable: !0 }),
      );
      (this[B].dispatchEvent(t), t.defaultPrevented || this.client[z](e.code, e.reason));
    }
  },
  mt = class extends EventTarget {
    constructor(e) {
      (super(),
        (this.socket = e),
        this.socket.addEventListener(`close`, (e) => {
          this.dispatchEvent(j(this.socket, new F(`close`, e)));
        }),
        (this.socket[lt] = (e) => {
          this.dispatchEvent(
            j(this.socket, new P(`outgoing`, { data: e, origin: this.socket.url, cancelable: !0 })),
          );
        }));
    }
    addEventListener(e, t, n) {
      ...
      queueMicrotask(() => {
        ...
        let t = () => {
          this.socket.dispatchEvent(
            j(this.socket, new MessageEvent(`message`, { data: e, origin: this.socket.url })),
          );
        };
  ...
  ht = class e extends E {
    ...
    setup() {
            ...
            return (
              queueMicrotask(async () => {
                try {
                  ...
                  (await O(this.emitter, `connection`, {
                    client: new st(o, s),
                    server: e,
                    info: { protocols: i },
                  }),
                      ...
                      : (o[R].resolve(!0),
                        ...
                        e.addEventListener(`open`, () => {
                          (o.dispatchEvent(j(o, new Event(`open`))),
                            e.realWebSocket && (o.protocol = e.realWebSocket.protocol));
                        })));
                } catch (e) {
                  e instanceof Error &&
      ...
      (Object.defineProperty(globalThis, `WebSocket`, { value: t, configurable: !0 }),
        this.subscriptions.push(() => {
...
var G = class e extends Response {
    static {
...
function Ot(e, t, n) {
  return (
    [e.active, e.installing, e.waiting].filter((e) => e != null).find((e) => n(e.scriptURL, t)) ||
    null
  );
}
var kt = async (e, t = {}, n) => {
    let r = Dt(e),
      i = await navigator.serviceWorker
        .getRegistrations()
        .then((e) => e.filter((e) => Ot(e, r, n)));
    !navigator.serviceWorker.controller && i.length > 0 && location.reload();
    let [o] = i;
    if (o) return (o.update(), [Ot(o, r, n), o]);
    let [s, c] = await Et(async () => {
    ...
    if (s) {
      if (s.message.includes(`(404)`)) {
        ...
        throw Error(
          a.formatMessage(`Failed to register a Service Worker for scope ('${e.href}') with script ('${r}'): Service Worker script does not exist at the given path.
...
%s`,
  ...
  K = Symbol(`kDefaultPrevented`),
  q = Symbol(`kPropagationStopped`),
  J = Symbol(`kImmediatePropagationStopped`),
  jt = class extends MessageEvent {
    [K];
    [q];
    [J];
    constructor(...e) {
      (super(e[0], e[1]), (this[K] = !1));
    }
    get defaultPrevented() {
      return this[K];
    }
    preventDefault() {
      (super.preventDefault(), (this[K] = !0));
    }
    stopImmediatePropagation() {
      (super.stopImmediatePropagation(), (this[J] = !0));
    }
  },
  Mt = Symbol(`kListenerOptions`),
  Nt = class {
    #e;
    constructor() {
      this.#e = new At();
    ...
    emit(e) {
      ...
      let t = this.listenerCount(e.type) > 0,
        n = this.#n(e);
      for (let t of this.#i(e.type)) {
        if (n.event[q] != null && n.event[q] !== this) return (n.revoke(), !1);
        if (n.event[J]) break;
        this.#r(n.event, t);
      }
      return (n.revoke(), t);
    ...
    async emitAsPromise(e) {
      ...
      let t = [],
        n = this.#n(e);
      for (let r of this.#i(e.type)) {
        if (n.event[q] != null && n.event[q] !== this) return (n.revoke(), []);
        if (n.event[J]) break;
        let e = await Promise.resolve(this.#r(n.event, r));
        this.#a(r) || t.push(e);
      }
    ...
    *emitAsGenerator(e) {
      ...
      let t = this.#n(e);
      for (let n of this.#i(e.type)) {
        if (t.event[q] != null && t.event[q] !== this) {
          t.revoke();
          return;
        }
        if (t.event[J]) break;
    ...
    #t(e, t, n, r = `append`) {
      (r === `prepend` ? this.#e.prepend(e, t) : this.#e.append(e, t),
        n &&
          (Object.defineProperty(t, Mt, { value: n, enumerable: !1, writable: !1 }),
          n.signal &&
            n.signal.addEventListener(
              `abort`,
              () => {
    ...
    #n(e) {
      ...
      return (
        (e.stopPropagation = new Proxy(e.stopPropagation, {
          apply: (t, n, r) => ((e[q] = this), Reflect.apply(t, n, r)),
        })),
        {
          event: e,
          revoke() {
  ...
  Ft = class extends jt {
    ...
    postMessage(e, ...t) {
      this.#e.ports[0].postMessage({ type: e, data: t[0] }, { transfer: t[1] });
    }
  },
  It = class extends Nt {
    constructor(e) {
      (super(),
        ...
        Pt &&
          navigator.serviceWorker.addEventListener(`message`, async (e) => {
            let t = await this.options.worker;
            (e.source != null && e.source !== t) ||
              (e.data && ue(e.data) && `type` in e.data && this.emit(new Ft(e)));
          }));
    }
    postMessage(e) {
      (b(
...
function Rt(e) {
  return new Request(e.url, { ...e, body: Lt(e) });
}
function zt(e) {
  location.href.startsWith(e.scope) ||
    a.warn(`Cannot intercept requests on this page because it's outside of the worker's scope ("${e.scope}"). If you wish to mock API requests on this page, you must resolve this scope issue.
...
var Bt = class extends ge {
    constructor(e) {
      (super(),
        ...
        (this.#e = new Map()),
        (this.workerPromise = new A()),
        (this.#t = new It({ worker: this.workerPromise.then(([e]) => e) })));
    }
    #e;
    #t;
    #n;
    ...
    workerPromise;
    async enable() {
      if (((this.#i = void 0), this.workerPromise.state !== `pending`))
        return (
          a.warn(
    ...
    disable() {
      ...
      ((this.#i = Date.now()),
        this.#e.clear(),
        (this.workerPromise = new A()),
        this.options.quiet || this.#d());
    }
    async #a() {
      this.#r && clearInterval(this.#r);
      let e = this.options.serviceWorker.url,
        [t, n] = await kt(
          e,
          this.options.serviceWorker.options,
          this.options.findWorker || this.#c,
        );
      if (t == null) {
        let t = this.options?.findWorker
          ? a.formatMessage(
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`,
      ...
      return (
        ...
        this.#t.on(`REQUEST`, this.#o.bind(this)),
        this.#t.on(`RESPONSE`, this.#s.bind(this)),
        window.addEventListener(`beforeunload`, () => {
          (t.state !== `redundant` && this.#t.postMessage(`CLIENT_CLOSED`),
            clearInterval(this.#r),
            window.postMessage({ type: `msw/worker:stop` }));
        }),
        await this.#l().catch((e) => {
          (a.error(
        ...
        (this.#r = window.setInterval(() => {
          this.#t.postMessage(`KEEPALIVE_REQUEST`);
        }, 5e3)),
        this.options.quiet || zt(n),
        [t, n]
      );
    }
    async #o(e) {
      if (this.#i && e.data.interceptedAt > this.#i) return e.postMessage(`PASSTHROUGH`);
      let t = Rt(e.data);
      c.cache.set(t, t.clone());
      let n = new Vt({ event: e, request: t });
      (this.#e.set(e.data.id, n), await this.queue(n));
    }
    async #s(e) {
      ...
      let i = this.#e.get(t.id);
      if ((this.#e.delete(t.id), i == null)) return;
      let a = Rt(t),
        o =
          n.status === 0
            ? Response.error()
            : new G(G.isResponseWithBody(n.status) ? n.body : null, { ...n, url: t.url });
      i.events.emit(
        new xe(r ? `response:mocked` : `response:bypass`, {
          requestId: i.data.id,
          request: a,
    ...
    async #l() {
      ...
      return (
        ...
        this.#t.once(`INTEGRITY_CHECK_RESPONSE`, (t) => {
          ...
          (n !== `4db4a41e972cec1b64cc569c66952d82` &&
            a.warn(`The currently registered Service Worker has been generated by a different version of MSW (${r}) and may not be fully compatible with the installed version.
...
You can also automate this process and make the worker script update automatically upon the library installations. Read more: https://mswjs.io/docs/cli/init.`),
    ...
    async #u() {
      ...
      (console.groupCollapsed(
        `%c${a.formatMessage(`Mocking enabled.`)}`,
    ...
    #d() {
      console.log(`%c${a.formatMessage(`Mocking disabled.`)}`, `color:orangered;font-weight:bold;`);
    }
  },
  Vt = class extends v {
    #e;
    ...
    errorWith(e) {
      ...
      let n = e instanceof Error ? e : Error(e?.toString() || `Request failure`);
      this.respondWith(
        t.json(
...
function Wt(e) {
  return new Response(
    JSON.stringify(e instanceof Error ? { name: e.name, message: e.message, stack: e.stack } : e),
    {
      status: 500,
...
function Gt(e) {
  return e != null && e instanceof Response && Y(e, `type`) && e.type === `error`;
}
function Kt(e) {
  return Ut(e, !0) && Y(e, `status`) && Y(e, `statusText`) && Y(e, `bodyUsed`);
}
function qt(e) {
...
async function Jt(e) {
      ...
      t instanceof Error
        ...
        : Gt(t) || Kt(t)
          ...
          : Ut(t)
            ...
            : !1,
    n = async (n) => {
      if (n instanceof U) throw i.error;
      return qt(n)
  ...
  let i = await Ht(async () => {
    let t = O(e.emitter, `request`, {
  ...
  if (i.error) {
    ...
    if (e.emitter.listenerCount(`unhandledException`) > 0) {
      ...
      if (
        (await O(e.emitter, `unhandledException`, {
          error: i.error,
          request: e.request,
          requestId: e.requestId,
          controller: n,
        }),
        n.readyState !== W.PENDING)
      )
        return;
    }
    await e.controller.respondWith(Wt(i.error));
    return;
  }
  return e.controller.readyState === W.PENDING
...
var Yt = [
  ...
  Xt = Symbol(`kRedirectCount`);
async function Zt(e, t) {
  if (t.status !== 303 && e.body != null) return Promise.reject(X());
  let n = new URL(e.url),
    r;
  try {
    r = new URL(t.headers.get(`location`), e.url);
  } catch (e) {
    return Promise.reject(X(e));
  }
  if (!(r.protocol === `http:` || r.protocol === `https:`))
    return Promise.reject(X(`URL scheme must be a HTTP(S) scheme`));
  if (Reflect.get(e, Xt) > 20) return Promise.reject(X(`redirect count exceeded`));
  if (
    (Object.defineProperty(e, Xt, { value: (Reflect.get(e, Xt) || 0) + 1 }),
    e.mode === `cors` && (r.username || r.password) && !Qt(n, r))
  )
    return Promise.reject(X(`cross origin not allowed for request mode "cors"`));
  let i = {};
  ...
  return (Object.defineProperty(a, `redirected`, { value: !0, configurable: !0 }), a);
}
function Qt(e, t) {
  return (
...
function rn(e) {
  ...
  let t = nn(e.headers.get(`content-encoding`) || ``);
  return t ? (e.body.pipeTo(t.writable), t.readable) : null;
}
var an = class e extends E {
  static {
  ...
  async setup() {
    ...
    (b(!e[H], `Failed to patch the "fetch" module: already patched.`),
      (globalThis.fetch = async (t, n) => {
        let r = D(),
          i =
            typeof t == `string` && typeof location < `u` && !vt(t) ? new URL(t, location.href) : t,
          a = new Request(i, n);
        t instanceof Request && xt(a, t);
        let o = new A(),
          s = new W(a, {
            passthrough: async () => {
              this.logger.info(`request has not been handled, passthrough...`);
              let t = a.clone(),
                { error: n, data: i } = await Ht(() => e(a));
              if (n) return o.reject(n);
              if (
                (this.logger.info(`original fetch performed`, i),
                this.emitter.listenerCount(`response`) > 0)
              ) {
                this.logger.info(`emitting the "response" event...`);
                let e = i.clone();
                await O(this.emitter, `response`, {
                  response: e,
                  isMockedResponse: !1,
                  request: t,
                  requestId: r,
            ...
            respondWith: async (e) => {
              if (Gt(e)) {
                (this.logger.info(`request has errored!`, { response: e }), o.reject(X(e)));
                return;
              }
              this.logger.info(`received mocked response!`, { rawResponse: e });
              let t = rn(e),
                n = t === null ? e : new G(t, e);
              if ((G.setUrl(a.url, n), G.isRedirectResponse(n.status))) {
                if (a.redirect === `error`) {
                  o.reject(X(`unexpected redirect`));
                  return;
                }
            ...
            errorWith: (e) => {
              (this.logger.info(`request has been aborted!`, { reason: e }), o.reject(e));
            },
          });
        return (
          ...
          await Jt({ request: a, requestId: r, emitter: this.emitter, controller: s }),
          o
        );
      }),
      Object.defineProperty(globalThis.fetch, H, { enumerable: !0, configurable: !0, value: !0 }),
      this.subscriptions.push(() => {
        (Object.defineProperty(globalThis.fetch, H, { value: void 0 }),
          (globalThis.fetch = e),
...
var sn = class {
  ...
  ln = typeof ProgressEvent < `u`;
function un(e, t, n) {
  let r = [`error`, `progress`, `loadstart`, `loadend`, `load`, `timeout`, `abort`],
    i = ln ? ProgressEvent : cn;
  return r.includes(t)
    ? new i(t, { lengthComputable: !0, loaded: n?.loaded || 0, total: n?.total || 0 })
    : new sn(t, { target: e, currentTarget: e });
}
function dn(e, t) {
  if (!(t in e)) return null;
  if (Object.prototype.hasOwnProperty.call(e, t)) return e;
  let n = Reflect.getPrototypeOf(e);
  return n ? dn(n, t) : null;
}
function fn(e, t) {
  return new Proxy(e, pn(t));
}
function pn(e) {
...
function gn(e, t) {
  return new G(G.isResponseWithBody(e.status) ? t : null, {
    url: e.responseURL,
    status: e.status,
    statusText: e.statusText,
    headers: _n(e.getAllResponseHeaders()),
  });
}
function _n(e) {
  let t = new Headers(),
...
var Z = Symbol(`kIsRequestHandled`),
  yn = x(),
  Q = Symbol(`kFetchRequest`),
  bn = class {
    constructor(e, t) {
          ...
          methodCall: ([e, t], n) => {
            switch (e) {
              case `open`: {
                ...
                return (
                  r === void 0
                    ? ((this.method = `GET`), (this.url = xn(e)))
                    : ((this.method = e), (this.url = xn(r))),
              ...
              case `addEventListener`: {
                let [e, r] = t;
                return (this.registerEvent(e, r), this.logger.info(`addEventListener`, e, r), n());
              }
              case `setRequestHeader`: {
                let [e, r] = t;
                return (
                  this.requestHeaders.set(e, r), this.logger.info(`setRequestHeader`, e, r), n()
                );
              }
              case `send`: {
                let [e] = t;
                this.request.addEventListener(`load`, () => {
                  if (this.onResponse !== void 0) {
                    let e = gn(this.request, this.request.response);
                    this.onResponse.call(this, {
                      response: e,
                      isMockedResponse: this[Z],
                      request: i,
                      requestId: this.requestId,
                    });
                  }
                });
                let r = typeof e == `string` ? Ct(e) : e,
                    ...
                    (
                      ...
                      if (!this[Z])
                        return (
                          ...
                          yn && this.request.setRequestHeader(et, this.requestId),
                          n()
                        );
                    });
                  }));
    ...
    registerUploadEvent(e, t) {
      ...
      (this.uploadEvents.set(e, n), this.logger.info(`registered upload event "%s"`, e, t));
    }
    async respondWith(e) {
      if (((this[Z] = !0), this[Q])) {
        let e = await vn(this[Q]);
      ...
      (this.logger.info(`responding with a mocked response: %d %s`, e.status, e.statusText),
        ...
        (this.request.getResponseHeader = new Proxy(this.request.getResponseHeader, {
          apply: (t, n, r) => {
            ...
            return (this.logger.info(`resolved response header "%s" to`, r[0], i), i);
          },
        })),
        (this.request.getAllResponseHeaders = new Proxy(this.request.getAllResponseHeaders, {
          apply: () => {
            ...
            let t = Array.from(e.headers.entries()).map(([e, t]) => `${e}: ${t}`).join(`\r
`);
        ...
        let r = e.body.getReader(),
          i = async () => {
            ...
            (e &&
              ...
              (this.responseBuffer = on(this.responseBuffer, e)),
    ...
    get response() {
      ...
      switch (this.request.responseType) {
        case `json`: {
          let e = hn(this.responseBufferToText());
          return (this.logger.info(`resolved response JSON`, e), e);
        }
        case `arraybuffer`: {
          let e = Tt(this.responseBuffer);
        ...
        default: {
          ...
          return (
            this.logger.info(`resolving "%s" response type as text`, this.request.responseType, e),
            e
          );
        }
      }
    ...
    trigger(e, t, n) {
      ...
      (this.logger.info(`trigger "%s"`, e, n || ``),
        typeof r == `function` &&
          (this.logger.info(`found a direct "%s" callback, calling...`, e), r.call(t, i)));
      let a = t instanceof XMLHttpRequestUpload ? this.uploadEvents : this.events;
      for (let [n, r] of a)
        n === e &&
          (this.logger.info(`found %d listener(s) for "%s" event, calling...`, r.length, e),
          r.forEach((e) => e.call(t, i)));
    }
    toFetchApiRequest(e) {
      this.logger.info(`converting request to a Fetch API Request...`);
      let t = e instanceof Document ? e.documentElement.innerText : e,
        n = new Request(this.url.href, {
          method: this.method,
...
function Sn({ emitter: e, logger: t }) {
      ...
      return (
        (s.onRequest = async function ({ request: t, requestId: n }) {
          ...
          (this.logger.info(`awaiting mocked response...`),
            ...
            await Jt({ request: t, requestId: n, controller: r, emitter: e }));
        }),
        (s.onResponse = async function ({
          ...
          (this.logger.info(
            ...
            e.emit(`response`, { response: t, isMockedResponse: n, request: r, requestId: i }));
        }),
        s.request
      );
    },
...
var Cn = class e extends E {
    ...
    checkEnvironment() {
      return k(`XMLHttpRequest`);
    }
    setup() {
      let e = this.logger.extend(`setup`);
      e.info(`patching "XMLHttpRequest" module...`);
      let t = globalThis.XMLHttpRequest;
      (b(!t[H], `Failed to patch the "XMLHttpRequest" module: already patched.`),
        (globalThis.XMLHttpRequest = Sn({ emitter: this.emitter, logger: this.logger })),
        ...
        this.subscriptions.push(() => {
          (Object.defineProperty(globalThis.XMLHttpRequest, H, { value: void 0 }),
  ...
  wn = class extends Ee {
    constructor(e) {
      (super({ interceptors: [new Cn(), new an()] }), (this.options = e));
    }
    enable() {
    ...
    #e() {
      (console.groupCollapsed(
        `%c${a.formatMessage(`Mocking enabled (fallback mode).`)}`,
        `color:orangered;font-weight:bold;`,
      ),
        console.log(
          `%cDocumentation: %chttps://mswjs.io/docs`,
  ...
  Tn = `/mockServiceWorker.js`;
function En(...e) {
  b(!x(), a.formatMessage("Failed to execute `setupWorker` in a non-browser environment"));
  let t = me({ sources: [], handlers: e });
  return {
    async start(e) {
      if (
      ...
      let n = gt()
        ? new Bt({
            serviceWorker: {
              url: e?.serviceWorker?.url?.toString() || Tn,
              options: e?.serviceWorker?.options,
            },
            findWorker: e?.findWorker,
            quiet: e?.quiet,
          })
        : new wn({ quiet: e?.quiet });
      if (
        (t.configure({
          sources: [n, new Ee({ interceptors: [new ht()] })],
          onUnhandledFrame: ke(() => e?.onUnhandledRequest || `warn`),
...
export { En as setupWorker };
//# sourceMappingURL=browser-CYfZNVUj.js.map
