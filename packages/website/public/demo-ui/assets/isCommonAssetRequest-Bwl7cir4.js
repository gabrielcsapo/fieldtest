...
function n(n, ...r) {
  ...
  let i = 0,
    a = n.replace(e, (e, n, a, o) => {
      let s = r[i],
        c = t(s, o);
      return n ? e : (i++, c);
    });
  return (i < r.length && (a += ` ${r.slice(i).join(` `)}`), (a = a.replace(/%{2,2}/g, `%`)), a);
}
var r = 2;
function i(e) {
  if (!e.stack) return;
...
o.as = (e, t, r, ...i) => {
  if (!t) {
    let t = i.length === 0 ? r : n(r, ...i),
      a;
    try {
      a = Reflect.construct(e, [t]);
    } catch {
      a = e(t);
    }
    throw a;
...
var d = { formatMessage: c, warn: l, error: u },
  ...
  p = /[/\\]msw[/\\]src[/\\](.+)/,
  m = /(node_modules)?[/\\]lib[/\\](core|browser|node|native|iife)[/\\]|^[^/\\]*$/;
function h(e) {
  let t = e.stack;
  if (!t) return;
  let n = t
...
`)
    .slice(1)
    .find((e) => !(p.test(e) || m.test(e)));
  if (n) return n.replace(/\s*at [^()]*\(([^)]+)\)/, `$1`).replace(/^@/, ``);
}
function g(e) {
...
var _ = class e {
    ...
    cloneRequestOrGetFromCache(t) {
      ...
      let r = t.clone();
      return (e.cache.set(t, r), r);
    }
    async run(e) {
      if (this.isUsed && this.options?.once) return null;
      let t = this.cloneRequestOrGetFromCache(e.request),
        n = await this.parse({ request: e.request, resolutionContext: e.resolutionContext });
      if (
        ...
        return null;
      this.isUsed = !0;
      let r = await this.wrapResolver(this.resolver)({
        ...this.extendResolverArgs({ request: e.request, parsedResult: n }),
      ...
      return async (t) => {
        if (!this.resolverIterator) {
          ...
          this.resolverIterator =
            Symbol.iterator in n ? n[Symbol.iterator]() : n[Symbol.asyncIterator]();
        }
        this.isUsed = !1;
        let { done: n, value: r } = await this.resolverIterator.next(),
          i = await r;
        return (
          i && (this.resolverIteratorResult = i.clone()),
          n ? ((this.isUsed = !0), this.resolverIteratorResult?.clone()) : i
        );
      };
    }
  ...
  ee = (e, t) =>
    function () {
      return (t || (0, e[x(e)[0]])((t = { exports: {} }).exports, t), t.exports);
    },
  w = (e, t, n, r) => {
    if ((t && typeof t == `object`) || typeof t == `function`)
      for (let i of x(t))
        !C.call(e, i) &&
          i !== n &&
          y(e, i, { get: () => t[i], enumerable: !(r = b(t, i)) || r.enumerable });
    return e;
  },
  te = (e, t, n) => (
    (n = e == null ? {} : v(S(e))),
    w(t || !e || !e.__esModule ? y(n, `default`, { value: e, enumerable: !0 }) : n, e)
  ),
  ne = ee({
    ...
    ee({
      "node_modules/.pnpm/statuses@2.0.2/node_modules/statuses/index.js"(e, t) {
        ...
        ((t.exports = s),
          ...
          (s.code = r(n)),
          (s.codes = i(n)),
          (s.redirect = { 300: !0, 301: !0, 302: !0, 303: !0, 305: !0, 307: !0, 308: !0 }),
          (s.empty = { 204: !0, 205: !0, 304: !0 }),
          (s.retry = { 502: !0, 503: !0, 504: !0 }));
        function r(e) {
          var t = {};
          return (
        ...
        function a(e) {
          var t = e.toLowerCase();
          if (!Object.prototype.hasOwnProperty.call(s.code, t))
            throw Error(`invalid status message: "` + e + `"`);
          return s.code[t];
        }
        function o(e) {
          if (!Object.prototype.hasOwnProperty.call(s.message, e))
            throw Error(`invalid status code: ` + e);
          return s.message[e];
        }
        function s(e) {
...
function re(e) {
  for (var t = [], n = 0; n < e.length; ) {
    ...
    if (r === `(`) {
      ...
      (t.push({ type: `PATTERN`, index: n, value: c }), (n = a));
      continue;
    }
...
function ie(e, t) {
  ...
  for (var n = /\((?:\?<(.*?)>)?(?!\?)/g, r = 0, i = n.exec(e.source); i; )
    (t.push({ name: i[1] || r++, prefix: ``, suffix: ``, modifier: ``, pattern: `` }),
      (i = n.exec(e.source)));
  return e;
}
function N(e, t, n) {
  var r = e.map(function (e) {
    return se(e, t, n).source;
  });
  return RegExp(`(?:${r.join(`|`)})`, M(n));
}
function ae(e, t, n) {
  return oe(O(e, n), t, n);
}
function oe(e, t, n) {
      ...
      if (y.pattern)
        if ((t && t.push(y), b || x))
          if (y.modifier === `+` || y.modifier === `*`) {
            var S = y.modifier === `*` ? `?` : ``;
            g += `(?:${b}((?:${y.pattern})(?:${x}${b}(?:${y.pattern}))*)${x})${S}`;
          } else g += `(?:${b}(${y.pattern})${x})${y.modifier}`;
        else {
          if (y.modifier === `+` || y.modifier === `*`)
            throw TypeError(`Can not repeat "${y.name}" without a prefix and suffix`);
  ...
  if (c) (i || (g += `${h}?`), (g += n.endsWith ? `(?=${m})` : `$`));
    ...
    var C = e[e.length - 1],
      ee = typeof C == `string` ? h.indexOf(C[C.length - 1]) > -1 : C === void 0;
    (i || (g += `(?:${h}(?=${m}))?`), ee || (g += `(?=${h}|${m})`));
  }
  return new RegExp(g, M(n));
}
function se(e, t, n) {
  return e instanceof RegExp ? ie(e, t) : Array.isArray(e) ? N(e, t, n) : ae(e, t, n);
}
function ce() {
  let e = (t, n) => {
    ((e.state = `pending`),
...
var de = class e extends Response {
  static {
  ...
  constructor(t, n = {}) {
    ...
    if ((super(a, { status: i, statusText: n.statusText, headers: n.headers }), r !== i)) {
      let e = F(`state`, this);
      e
        ? (e.status = r)
...
var pe = Object.defineProperty,
  ...
  he = {};
me(he, { blue: () => _e, gray: () => I, green: () => ye, red: () => ve, yellow: () => ge });
function ge(e) {
  ...
  R = class {
    constructor(e) {
      ...
      t === `1` || t === `true` || (t !== void 0 && this.name.startsWith(t))
        ? ((this.debug = V(n, `debug`) ? z : this.debug),
          (this.info = V(n, `info`) ? z : this.info),
          (this.success = V(n, `success`) ? z : this.success),
          (this.warning = V(n, `warning`) ? z : this.warning),
          (this.error = V(n, `error`) ? z : this.error))
        : ((this.info = z),
          (this.success = z),
          (this.warning = z),
          (this.error = z),
    ...
    logEntry(e) {
      let { level: t, message: n, prefix: r, colors: i, positionals: a = [] } = e,
        o = this.createEntry(t, n),
        s = i?.timestamp || `gray`,
        c = i?.prefix || `gray`,
        l = { timestamp: he[s], prefix: he[c] };
      this.getWriter(t)(
        [l.timestamp(this.formatTimestamp(o.timestamp))]
          .concat(r == null ? [] : l.prefix(r), H(n))
          .join(` `),
        ...a.map(H),
      );
    }
...
function B(e) {
  return L ? {}[e] : globalThis[e]?.toString();
}
function V(e, t) {
  return e !== void 0 && e !== t;
}
...
var we = class extends Error {
  ...
  U = class {
    ...
    constructor() {
      ((this.events = new Map()),
        (this.maxListeners = U.defaultMaxListeners),
    ...
    addListener(e, t) {
      ...
      if (
        ...
        let t = new we(this, e, this.listenerCount(e));
        console.warn(t);
      }
      return this;
    }
...
var W = (function (e) {
  ...
  ke = class {
    constructor(e) {
      ((this.symbol = e),
        (this.readyState = W.INACTIVE),
        (this.emitter = new Te()),
        (this.subscriptions = []),
        (this.logger = new R(e.description)),
    ...
    apply() {
      ...
      if ((e.info(`applying the interceptor...`), this.readyState === W.APPLIED)) {
        ...
        (e.info(`found a running instance, reusing...`),
          (this.on = (n, r) => (
            ...
            this.subscriptions.push(() => {
              (t.emitter.removeListener(n, r), e.info(`removed proxied "%s" listener!`, n));
            }),
            this
          )),
          (this.readyState = W.APPLIED));
        return;
      }
    ...
    on(e, t) {
      ...
      return this.readyState === W.DISPOSING || this.readyState === W.DISPOSED
        ? (n.info(`cannot listen to events, already disposed!`), this)
        : (n.info(`adding "%s" event listener:`, e, t), this.emitter.on(e, t), this);
    }
    once(e, t) {
    ...
    dispose() {
      ...
      if (
        (this.clearInstance(),
        e.info(`global symbol deleted:`, Ee(this.symbol)),
      ...
      (this.emitter.removeAllListeners(),
        ...
        (this.readyState = W.DISPOSED));
    }
    getInstance() {
      let e = Ee(this.symbol);
      return (this.logger.info(`retrieved global instance:`, e?.constructor?.name), e);
    }
    setInstance() {
      (De(this.symbol, this), this.logger.info(`set global instance!`, this.symbol.description));
    }
    clearInstance() {
      (Oe(this.symbol), this.logger.info(`cleared global instance!`, this.symbol.description));
    }
  };
function Ae() {
...
var je = class e extends ke {
  ...
  on(e, t) {
    for (let n of this.interceptors) n.on(e, t);
    return this;
  }
  once(e, t) {
    for (let n of this.interceptors) n.once(e, t);
    return this;
  }
  off(e, t) {
    for (let n of this.interceptors) n.off(e, t);
    return this;
  }
  removeAllListeners(e) {
...
var Ne = /[?|#].*$/g;
function Pe(e) {
  return e.endsWith(`?`) ? e : e.replace(Ne, ``);
}
function Fe(e) {
  return /^([a-z][a-z\d+\-.]*:)?\/\//i.test(e);
}
function Ie(e, t) {
  if (Fe(e) || e.startsWith(`*`)) return e;
  let n = t || (typeof location < `u` && location.href);
  return n ? decodeURI(new URL(encodeURI(e), n).href) : e;
}
function Le(e, t) {
  return e instanceof RegExp ? e : Pe(Ie(e, t));
}
function Re(e) {
  return e
    .replace(/([:a-zA-Z_-]*)(\*{1,2})+/g, (e, t, n) => {
      let r = `(.*)`;
      return t ? (t.startsWith(`:`) ? `${t}${n}` : `${t}${r}`) : r;
    })
    .replace(/([^/])(:)(?=(?:\d+|\(\.\*\))(?=\/|$))/, `$1\\$2`)
    .replace(/^([^/]+)(:)(?=\/\/)/, `$1\\$2`);
}
function ze(e, t, n) {
  let r = Le(t, n),
    i = typeof r == `string` ? Re(r) : r,
    a = Me(e),
    o = k(i, { decode: decodeURIComponent })(a),
    s = (o && o.params) || {};
  return { matches: o !== !1, params: s };
}
function Be(e) {
  let t = e instanceof URL ? e : new URL(e);
  return typeof location < `u` && t.origin === location.origin ? t.pathname : t.origin + t.pathname;
}
function Ve(e, t) {
...
function Ue(e, t, n) {
  if (n.validHosts !== null) {
    let e = n.validHosts;
    for (let n of e) if (Ve(t, n)) return n;
  }
  let r = 0;
  if (t.startsWith(`.`)) for (; r < t.length && t[r] === `.`; ) r += 1;
  return e.length === t.length - r ? null : He(t, e);
}
function We(e, t) {
    ...
    if (e.charCodeAt(n) === 47 && e.charCodeAt(n + 1) === 47) n += 2;
      ...
      if (t !== -1) {
        let r = t - n,
          ...
          c = e.charCodeAt(n + 4);
        if (
          !(r === 5 && i === 104 && a === 116 && o === 116 && s === 112 && c === 115) &&
          ...
          for (let r = n; r < t; r += 1) {
            ...
            if (
              !((t >= 97 && t <= 122) || (t >= 48 && t <= 57) || t === 46 || t === 45 || t === 43)
            )
              return null;
          }
...
function Xe(e) {
  if (
    e.length > 255 ||
    e.length === 0 ||
    (!Ye(e.charCodeAt(0)) && e.charCodeAt(0) !== 46 && e.charCodeAt(0) !== 95)
  )
    return !1;
  let t = -1,
    n = -1,
  ...
  for (let i = 0; i < r; i += 1) {
    ...
    if (r === 46) {
      ...
      t = i;
    } else if (!(Ye(r) || r === 45 || r === 95)) return !1;
    n = r;
  }
...
function rt(e, t, n, r, i) {
  ...
  return typeof e != `string` ||
    (a.extractHostname
      ? a.mixedInputs
        ? (i.hostname = Ge(e, Xe(e)))
        : (i.hostname = Ge(e, !1))
      : (i.hostname = e),
    a.detectIp && i.hostname !== null && ((i.isIp = Je(i.hostname)), i.isIp))
    ? i
    : a.validateHostname && a.extractHostname && i.hostname !== null && !Xe(i.hostname)
      ? ((i.hostname = null), i)
      : (t === 0 ||
          i.hostname === null ||
          (n(i.hostname, a, i), t === 2 || i.publicSuffix === null) ||
          ((i.domain = Ue(i.publicSuffix, i.hostname, a)), t === 3 || i.domain === null) ||
          ((i.subdomain = et(i.hostname, i.domain)), t === 4) ||
          (i.domainWithoutSuffix = We(i.domain, i.publicSuffix)),
        i);
}
function it(e, t, n) {
...
var at = (function () {
    ...
    return [
      0,
      {
        ...
        jp: [
          0,
          { kawasaki: t, kitakyushu: t, kobe: t, nagoya: t, sapporo: t, sendai: t, yokohama: t },
        ],
      },
    ];
  })(),
  ot = (function () {
    let e = [1, {}],
      ...
      _ = [0, { notebook: t, "notebook-fips": t, studio: t, "studio-fips": t }],
      v = [0, { shop: t }],
      y = [0, { "*": e }],
      b = [1, { co: t }],
      x = [0, { objects: t }],
      S = [2, { "eu-west-1": t, "us-east-1": t }],
      C = [2, { nodes: t }],
      ee = [0, { my: t }],
      w = [0, { s3: t, "s3-accesspoint": t, "s3-website": t }],
      te = [0, { s3: t, "s3-accesspoint": t }],
      ne = [0, { direct: t }],
      ...
      A = [
        0,
        { s3: t, "s3-accesspoint": t, "s3-accesspoint-fips": t, "s3-fips": t, "s3-website": t },
      ],
      j = [
        0,
        {
      ...
      fe = [0, { dyn: t }],
      pe = [2, { web: t }],
      me = [1, { co: e, com: e, edu: e, gov: e, net: e, org: e }],
      he = [0, { p: t }],
      ge = [0, { user: t }],
      _e = [1, { ms: t }],
      I = [0, { cdn: t }],
      ve = [2, { raw: i }],
      ye = [0, { cust: t, reservd: t }],
      L = [0, { cust: t }],
      R = [0, { s3: t }],
      be = [1, { biz: e, com: e, edu: e, gov: e, info: e, net: e, org: e }],
      z = [0, { ipfs: t }],
      xe = [1, { framer: t }],
      Se = [0, { forgot: t }],
      Ce = [0, { core: [0, { blob: t, file: t, web: t }], servicebus: t }],
      B = [1, { gs: e }],
      V = [0, { nes: e }],
    ...
    return [
      0,
      {
        ...
        ai: [1, { com: e, net: e, off: e, org: e, uwu: t, framer: t, kiloapps: t }],
        al: r,
        ...
        ba: [1, { com: e, edu: e, gov: e, mil: e, net: e, org: e, brendly: v, rs: t }],
        bb: [
          1,
          { biz: e, co: e, com: e, edu: e, gov: e, info: e, net: e, org: e, store: e, tv: e },
        ],
        bd: [
          1,
          {
        ...
        ch: [
          1,
          {
            square7: t,
            cloudns: t,
            cloudscale: [0, { cust: t, lpg: x, rma: x }],
          ...
          1,
          {
            ...
            com: [
              1,
              {
                ...
                amazonwebservices: [0, { on: [0, { "cn-north-1": u, "cn-northwest-1": u }] }],
        ...
        com: [
          1,
          {
            ...
            salesforce: [
              0,
              { platform: [0, { "code-builder-stg": [0, { test: [0, { "001": i }] }] }] },
            ],
            logoip: t,
            scrysec: t,
            "firewall-gateway": t,
        ...
        ee: [
          1,
          { aip: e, com: e, edu: e, fie: e, gov: e, lib: e, med: e, org: e, pri: e, riik: e },
        ],
        eg: [
          1,
          {
        ...
        eu: [
          1,
          {
            amazonwebservices: [0, { on: [0, { "eusc-de-east-1": [0, { "cognito-idp": N }] }] }],
            cloudns: t,
            prvw: t,
            deuxfleurs: t,
            dogado: [0, { jelastic: t }],
        ...
        hr: [1, { com: e, from: e, iz: e, name: e, brendly: v }],
        ht: [
          1,
          {
            adult: e,
        ...
        "xn--4dbrk0ce": [
          1,
          { "xn--4dbgdty6c": e, "xn--5dbhl8d": e, "xn--8dbq2a": e, "xn--hebda8b": e },
        ],
        ...
        io: [
          1,
          {
            ...
            edugit: t,
            telebit: t,
            thingdust: [0, { dev: ye, disrec: ye, prod: L, testing: ye }],
            tickets: t,
            webflow: t,
            webflowtest: t,
            "drive-platform": t,
        ...
        jp: [
          1,
          {
            ...
            rgr: t,
            rulez: t,
            sakurastorage: [0, { isk01: R, isk02: R }],
            saloon: t,
            sblo: t,
            skr: t,
            tank: t,
        ...
        kg: [1, { com: e, edu: e, gov: e, mil: e, net: e, org: e, us: t, xx: t, ae: t }],
        kh: n,
        ki: be,
        km: [
          1,
        ...
        name: [1, { her: Se, his: Se, ispmanager: t, keenetic: t }],
        nc: [1, { asso: e, nom: e }],
        ne: e,
        net: [
          1,
          {
            ...
            massivegrid: [
              0,
              { paas: [0, { "fr-1": t, "lon-1": t, "lon-2": t, "ny-1": t, "ny-2": t, "sg-1": t }] },
            ],
        ...
        nf: [
          1,
          { arts: e, com: e, firm: e, info: e, net: e, other: e, per: e, rec: e, store: e, web: e },
        ],
        ng: [
          1,
          {
        ...
        org: [
          1,
          {
            ...
            fedorainfracloud: t,
            fedorapeople: t,
            fedoraproject: [0, { cloud: t, os: P, stg: [0, { os: P }] }],
            freedesktop: t,
            hatenadiary: t,
            hepforge: t,
            "in-dsl": t,
        ...
        pa: [
          1,
          { abo: e, ac: e, com: e, edu: e, gob: e, ing: e, med: e, net: e, nom: e, org: e, sld: e },
        ],
        ...
        pt: [
          1,
          { com: e, edu: e, gov: e, int: e, net: e, nome: e, org: e, publ: e, "123paginaweb": t },
        ],
        ...
        rs: [1, { ac: e, co: e, edu: e, gov: e, in: e, org: e, brendly: v, barsy: t, ox: t }],
        ru: [
          1,
          {
            ac: t,
        ...
        tv: [
          1,
          { "better-than": t, dyndns: t, "on-the-web": t, "worse-than": t, from: t, sakura: t },
        ],
        tw: [
          1,
          {
        ...
        uk: [
          1,
          {
            ...
            org: [
              1,
              { glug: t, lug: t, lugs: t, affinitylottery: t, raffleentry: t, weeklylottery: t },
            ],
            plc: e,
            police: e,
            sch: y,
        ...
        vc: [
          1,
          { com: e, edu: e, gov: e, mil: e, net: e, org: e, gv: [2, { d: t }], "0e": i, mydns: t },
        ],
        ve: [
          1,
          {
        ...
        ws: [
          1,
          { com: e, edu: e, gov: e, net: e, org: e, advisor: i, cloud66: t, dyndns: t, mypets: t },
        ],
        yt: [1, { org: t }],
        "xn--mgbaam7a8h": e,
        امارات: e,
        ...
        zm: [
          1,
          { ac: e, biz: e, co: e, com: e, edu: e, gov: e, info: e, mil: e, net: e, org: e, sch: e },
        ],
        ...
        edeka: e,
        education: b,
        email: [1, { crisp: [0, { on: t }], intouch: t, tawk: he, tawkto: he }],
        emerck: e,
        energy: e,
        engineer: e,
        engineering: e,
        ...
        netbank: e,
        netflix: e,
        network: [1, { aem: t, alces: i, appwrite: t, co: t, arvo: t, azimuth: t, tlon: t }],
        neustar: e,
        new: e,
        news: [1, { noticeable: t }],
        next: e,
        ...
        рус: [
          1,
          { биз: t, ком: t, крым: t, мир: t, мск: t, орг: t, самара: t, сочи: t, спб: t, я: t },
        ],
        "xn--pssy2u": e,
        大拿: e,
        "xn--q9jyb4c": e,
        ...
        "xn--zfr164b": e,
        政务: e,
        xyz: [1, { caffeine: t, exe: t, botdash: t, telebit: i }],
        yachts: e,
        yahoo: e,
        yamaxun: e,
        yandex: e,
...
function st(e, t, n, r) {
  ...
  for (
    ...
    a !== void 0 &&
    ((a[0] & r) !== 0 &&
      (i = { index: n + 1, isIcann: (a[0] & 1) != 0, isPrivate: (a[0] & 2) != 0 }),
    n !== -1);
  ) {
    let t = a[1];
...
var lt = tt();
function ut(e, t = {}) {
  return (nt(lt), rt(e, 3, ct, t, lt).domain);
}
function dt(e, t) {
  return !!(
    t === e ||
    (e.indexOf(t) === 0 && (t[t.length - 1] === `/` || (e.startsWith(t) && e[t.length] === `/`)))
  );
}
var ft = [`local`, `example`, `invalid`, `localhost`, `test`],
  pt = [`localhost`, `invalid`],
  mt = { allowSpecialUseDomain: !1, ignoreError: !1 };
function ht(e, t = {}) {
  t = { ...mt, ...t };
  let n = e.split(`.`),
    r = n[n.length - 1],
    i = !!t.allowSpecialUseDomain,
    a = !!t.ignoreError;
  if (i && r !== void 0 && ft.includes(r)) {
    if (n.length > 1) return `${n[n.length - 2]}.${r}`;
    if (pt.includes(r)) return r;
  }
  if (!a && r !== void 0 && ft.includes(r))
    throw Error(
  ...
  let o = ut(e, { allowIcannDomains: !0, allowPrivateDomains: !0 });
  if (o) return o;
}
function gt(e, t) {
  let n = ht(e, { allowSpecialUseDomain: t });
  if (!n) return;
  if (n == e) return [e];
  ...
  let r = e
    ...
    i = n,
    a = [i];
  for (; r.length; ) ((i = `${r.shift()}.${i}`), a.push(i));
  return a;
}
var _t = class {
    constructor() {
  ...
  vt = (e) => Object.prototype.toString.call(e),
  yt = (e, t) =>
    typeof e.join == `function`
      ? (t.add(e), e.map((e) => (e == null || t.has(e) ? `` : bt(e, t))).join())
      : vt(e),
  bt = (e, t = new WeakSet()) =>
    typeof e != `object` || !e
      ? String(e)
...
function G(e) {
  ...
  return (
    ...
    { promise: i, callback: t, resolve: (e) => (t(null, e), i), reject: (e) => (t(e), i) }
  );
}
function St(e, t) {
  return e in t;
}
var Ct = class extends _t {
  constructor() {
    (super(), (this.synchronous = !0), (this.idx = Object.create(null)));
  }
  findCookie(e, t, n, r) {
    let i = G(r);
    if (e == null || t == null || n == null) return i.resolve(void 0);
    let a = this.idx[e]?.[t]?.[n];
    return i.resolve(a);
  }
  findCookies(e, t, n = !1, r) {
  ...
  putCookie(e, t) {
    let n = G(t),
      { domain: r, path: i, key: a } = e;
    if (r == null || i == null || a == null) return n.resolve(void 0);
    let o = this.idx[r] ?? Object.create(null);
    this.idx[r] = o;
    let s = o[i] ?? Object.create(null);
    return ((o[i] = s), (s[a] = e), n.resolve(void 0));
  }
  updateCookie(e, t, n) {
  ...
  removeCookie(e, t, n, r) {
    let i = G(r);
    return (delete this.idx[e]?.[t]?.[n], i.resolve(void 0));
  }
  removeCookies(e, t, n) {
    let r = G(n),
      i = this.idx[e];
    return (i && (t ? delete i[t] : delete this.idx[e]), r.resolve(void 0));
  }
  removeAllCookies(e) {
    let t = G(e);
  ...
  getAllCookies(e) {
    ...
    return (
      ...
      n.sort((e, t) => (e.creationIndex || 0) - (t.creationIndex || 0)),
      t.resolve(n)
    );
  }
};
...
function Dt(e) {
  return vt(e) === `[object Object]`;
}
function K(e, t, n) {
  if (e) return;
  let r = typeof t == `function` ? t : void 0,
    i = typeof t == `function` ? n : t;
  Dt(i) || (i = `[object Object]`);
  let a = new Ot(xt(i));
  if (r) r(a);
  else throw a;
}
var Ot = class extends Error {},
  kt = `6.0.1`,
  q = { SILENT: `silent`, STRICT: `strict`, DISABLED: `unsafe-disabled` };
Object.freeze(q);
var At = `
\\[?(?:
...
function J(e) {
  ...
  return jt.test(t)
    ? (t.startsWith(`[`) || (t = `[` + t), t.endsWith(`]`) || (t += `]`), Nt(t).slice(1, -1))
    : /[^\u0001-\u007f]/.test(t)
      ? Nt(t)
      : t.toLowerCase();
}
...
function Ft(e) {
  ...
  let t = { foundTime: void 0, foundDayOfMonth: void 0, foundMonth: void 0, foundYear: void 0 },
    n = e.split(Lt).filter((e) => e.length > 0);
  for (let e of n) {
    if (t.foundTime === void 0) {
      let [, n, r, i] = Rt.exec(e) || [];
      if (n != null && r != null && i != null) {
        let e = parseInt(n, 10),
          a = parseInt(r, 10),
          o = parseInt(i, 10);
        if (!isNaN(e) && !isNaN(a) && !isNaN(o)) {
          t.foundTime = { hours: e, minutes: a, seconds: o };
          continue;
        }
      }
    }
    if (t.foundDayOfMonth === void 0 && zt.test(e)) {
      let n = parseInt(e, 10);
      if (!isNaN(n)) {
        t.foundDayOfMonth = n;
        continue;
    ...
    if (t.foundMonth === void 0 && Bt.test(e)) {
      let n = It.indexOf(e.substring(0, 3).toLowerCase());
      if (n >= 0 && n <= 11) {
        t.foundMonth = n;
        continue;
      }
    }
    if (t.foundYear === void 0 && Vt.test(e)) {
      let n = parseInt(e, 10);
      if (!isNaN(n)) {
        t.foundYear = n;
        continue;
  ...
  if (
    (t.foundYear !== void 0 && t.foundYear >= 70 && t.foundYear <= 99 && (t.foundYear += 1900),
    t.foundYear !== void 0 && t.foundYear >= 0 && t.foundYear <= 69 && (t.foundYear += 2e3),
    t.foundDayOfMonth === void 0 ||
      t.foundMonth === void 0 ||
      t.foundYear === void 0 ||
      t.foundTime === void 0 ||
      t.foundDayOfMonth < 1 ||
  ...
  if (
    !(
      r.getUTCFullYear() !== t.foundYear ||
      r.getUTCMonth() !== t.foundMonth ||
      r.getUTCDate() !== t.foundDayOfMonth
    )
  )
    return r;
}
var It = [`jan`, `feb`, `mar`, `apr`, `may`, `jun`, `jul`, `aug`, `sep`, `oct`, `nov`, `dec`],
  Lt = /[\x09\x20-\x2F\x3B-\x40\x5B-\x60\x7B-\x7E]/,
  Rt = /^(\d{1,2}):(\d{1,2}):(\d{1,2})(?:[\x00-\x2F\x3A-\xFF][\x00-\xFF]*)?$/,
  zt = /^[0-9]{1,2}(?:[\x00-\x2F\x3A-\xFF][\x00-\xFF]*)?$/,
  Bt = /^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)[\x00-\xFF]*$/i,
  Vt = /^[\x30-\x39]{2,4}(?:[\x00-\x2F\x3A-\xFF][\x00-\xFF]*)?$/,
  Ht = /^[\x21\x23-\x2B\x2D-\x3A\x3C-\x5B\x5D-\x7E]+$/,
  Ut = /[\x20-\x3A\x3C-\x7E]+/,
  Wt = /[\x00-\x1F]/,
  Gt = [
    `
...
function qt(e, t) {
  ...
  if (
    (n <= 0
      ? ((r = ``), (i = e.trim()))
      : ((r = e.slice(0, n).trim()), (i = e.slice(n + 1).trim())),
    Wt.test(r) || Wt.test(i))
  )
    return;
  let a = new X();
...
function Jt(e, t) {
  ...
  e = e.trim();
  let n = e.indexOf(`;`),
    r = qt(n === -1 ? e : e.slice(0, n), t?.loose ?? !1);
  if (!r) return;
  if (n === -1) return r;
  ...
  for (; a.length; ) {
    ...
    let t = e.indexOf(`=`),
      ...
      i;
    switch (
      (t === -1 ? ((n = e), (i = null)) : ((n = e.slice(0, t)), (i = e.slice(t + 1))),
...
function Yt(e) {
  ...
  let n = new X();
  return (
    X.serializableProperties.forEach((e) => {
      if (t && typeof t == `object` && St(e, t)) {
        let r = t[e];
        if (r === void 0 || (St(e, Y) && r === Y[e])) return;
        switch (e) {
          case `key`:
          case `value`:
          case `sameSite`:
          ...
          case `creation`:
          case `lastAccessed`:
            typeof r == `number` || typeof r == `string` || r instanceof Date
              ? (n[e] = t[e] == `Infinity` ? `Infinity` : new Date(r))
              : r === null && (n[e] = null);
            break;
          case `maxAge`:
...
var Y = {
  ...
  Xt = class e {
    constructor(t = {}) {
      ((this.key = t.key ?? Y.key),
        (this.value = t.value ?? Y.value),
        (this.expires = t.expires ?? Y.expires),
        (this.maxAge = t.maxAge ?? Y.maxAge),
        (this.domain = t.domain ?? Y.domain),
        (this.path = t.path ?? Y.path),
        (this.secure = t.secure ?? Y.secure),
        (this.httpOnly = t.httpOnly ?? Y.httpOnly),
        (this.extensions = t.extensions ?? Y.extensions),
        (this.creation = t.creation ?? Y.creation),
        (this.hostOnly = t.hostOnly ?? Y.hostOnly),
        (this.pathIsDefault = t.pathIsDefault ?? Y.pathIsDefault),
        (this.lastAccessed = t.lastAccessed ?? Y.lastAccessed),
        (this.sameSite = t.sameSite ?? Y.sameSite),
      ...
      for (let n of e.serializableProperties) {
        ...
        if (e !== Y[n])
          switch (n) {
            ...
            case `creation`:
            case `lastAccessed`:
              typeof e == `number` || typeof e == `string` || e instanceof Date
                ? (t[n] = e == `Infinity` ? `Infinity` : new Date(e).toISOString())
                : e === null && (t[n] = null);
              break;
            case `maxAge`:
    ...
    validate() {
      if (
        !this.value ||
        !Ht.test(this.value) ||
        (this.expires != `Infinity` && !(this.expires instanceof Date) && !Ft(this.expires)) ||
        (this.maxAge != null &&
          this.maxAge !== `Infinity` &&
          (this.maxAge === `-Infinity` || this.maxAge <= 0)) ||
        (this.path != null && !Ut.test(this.path))
      )
        return !1;
      let e = this.cdomain();
      return !(e && (e.match(/\.$/) || ht(e) == null));
    }
    setExpires(e) {
      e instanceof Date ? (this.expires = e) : (this.expires = Ft(e) || `Infinity`);
    }
    setMaxAge(e) {
      e === 1 / 0
        ? (this.maxAge = `Infinity`)
    ...
    toString() {
      ...
      return (
        this.expires != `Infinity` &&
          ...
          (t += `; Expires=${Pt(this.expires)}`),
        this.maxAge != null && this.maxAge != 1 / 0 && (t += `; Max-Age=${String(this.maxAge)}`),
    ...
    TTL(e = Date.now()) {
      ...
      let t = this.expires;
      return t === `Infinity` ? 1 / 0 : (t?.getTime() ?? e) - (e || Date.now());
    }
    expiryTime(e) {
      if (this.maxAge != null) {
        let t = e || this.lastAccessed || new Date(),
          n = typeof this.maxAge == `number` ? this.maxAge : -1 / 0,
          r = n <= 0 ? -1 / 0 : n * 1e3;
        return t === `Infinity` ? 1 / 0 : t.getTime() + r;
      }
...
((Xt.cookiesCreated = 0),
  (Xt.sameSiteLevel = { strict: 3, lax: 2, none: 1 }),
  (Xt.sameSiteCanonical = { strict: `Strict`, lax: `Lax` }),
  (Xt.serializableProperties = [
    `key`,
    `value`,
    `expires`,
    `maxAge`,
...
function Qt(e, t) {
  ...
  return (
    (n = (t.path ? t.path.length : 0) - r),
    n !== 0 ||
      ((n =
        (e.creation && e.creation instanceof Date ? e.creation.getTime() : Zt) -
        (t.creation && t.creation instanceof Date ? t.creation.getTime() : Zt)),
      n !== 0) ||
      (n = (e.creationIndex || 0) - (t.creationIndex || 0)),
    n
  );
}
function $t(e) {
...
function tn(e, t, n) {
  ...
  let r, i;
  if ((n === !1 ? ((r = e), (i = t)) : ((r = J(e)), (i = J(t))), r == null || i == null)) return;
  if (r == i) return !0;
  let a = r.lastIndexOf(i);
  return a <= 0 || r.length !== i.length + a || r.substring(a - 1, a) !== `.` ? !1 : !en.test(r);
}
function nn(e) {
  let t = e.split(`.`);
...
function cn(e, t = !0) {
  ...
  let r = n.protocol.replace(`:`, ``).toLowerCase(),
    i = sn(n.hostname).replace(/\.+$/, ``);
  return r === `https` || r === `wss`
    ? !0
    : t
      ? Mt.test(i)
        ? nn(i)
...
var ln = { loose: !1, sameSiteContext: void 0, ignoreError: !1, http: !0 },
  un = { http: !0, expire: !0, allPaths: !1, sameSiteContext: void 0, sort: void 0 },
  dn = `Invalid sameSiteContext option for getCookies(); expected one of "strict", "lax", or "none"`;
function fn(e) {
  if (
    e &&
    typeof e == `object` &&
  ...
  else throw new Ot("`url` argument is not a string or URL.");
}
function pn(e) {
...
function hn(e) {
  return (
    !(typeof e.key == `string` && e.key.startsWith(`__Host-`)) ||
    !!(e.secure && e.hostOnly && e.path != null && e.path === `/`)
  );
}
function gn(e) {
  let t = e.toLowerCase();
...
var _n = class e {
  constructor(e, t) {
    (typeof t == `boolean` && (t = { rejectPublicSuffixes: t }),
      ...
      (this.prefixSecurity = gn(t?.prefixSecurity ?? `silent`)),
      (this.store = e ?? new Ct()));
  }
  callSync(e) {
    if (!this.store.synchronous)
      throw Error(`CookieJar store is not synchronous; use async API instead.`);
    let t = null,
      n;
    try {
      e.call(this, (e, r) => {
  ...
  setCookie(e, t, n, r) {
    ...
    let i = G(r),
      ...
      o;
    try {
      if ((typeof t == `string` && K(wt(t), r, xt(n)), (o = fn(t)), typeof t == `function`))
        return i.reject(Error(`No URL was specified`));
      if (
        (typeof n == `function` && (n = ln),
        K(typeof a == `function`, a),
        !wt(e) && !Dt(e) && e instanceof String && e.length == 0)
      )
        return i.resolve(void 0);
    } catch (e) {
      return i.reject(e);
    }
    let s = J(o.hostname) ?? null,
      c = n?.loose || this.enableLooseMode,
      l = null;
    if (n?.sameSiteContext && ((l = pn(n.sameSiteContext)), !l)) return i.reject(Error(dn));
    if (typeof e == `string` || e instanceof String) {
      let t = X.parse(e.toString(), { loose: c });
      if (!t) {
        let e = Error(`Cookie failed to parse`);
        return n?.ignoreError ? i.resolve(void 0) : i.reject(e);
      }
      e = t;
    ...
    if (e.domain) {
      if (!tn(s ?? void 0, e.cdomain() ?? void 0, !1)) {
        let t = Error(
          `Cookie not in this host's domain. Cookie:${e.cdomain() ?? `null`} Request:${s ?? `null`}`,
        );
        return n?.ignoreError ? i.resolve(void 0) : i.reject(t);
      }
      e.hostOnly ??= !1;
    } else ((e.hostOnly = !0), (e.domain = s));
    if (
      ((!e.path || e.path[0] !== `/`) && ((e.path = $t(o.pathname)), (e.pathIsDefault = !0)),
      n?.http === !1 && e.httpOnly)
    ) {
    ...
    let d = this.prefixSecurity === q.SILENT;
    if (this.prefixSecurity !== q.DISABLED) {
      let t = !1,
        r;
      if (
        (mn(e)
          ? hn(e) ||
            ((t = !0),
            (r = `Cookie has __Host prefix but either Secure or HostOnly attribute is not set or Path is not '/'`))
          : ((t = !0), (r = `Cookie has __Secure prefix but Secure attribute is not set`)),
        t)
      )
        return n?.ignoreError || d ? i.resolve(void 0) : i.reject(Error(r));
    }
    let f = this.store;
    return (
      (f.updateCookie ||= async function (e, t, n) {
        return this.putCookie(t).then(
          () => n?.(null),
          (e) => n?.(e),
        );
      }),
      f.findCookie(e.domain, e.path, e.key, function (t, r) {
        if (t) {
          a(t);
          return;
        }
        let i = function (t) {
          t ? a(t) : typeof e == `string` ? a(null, void 0) : a(null, e);
        };
        if (r) {
          if (n && `http` in n && n.http === !1 && r.httpOnly) {
            ((t = Error(`old Cookie is HttpOnly and this isn't an HTTP API`)),
              n.ignoreError ? a(null, void 0) : a(t));
            return;
          }
          e instanceof X &&
            ...
            (e.lastAccessed = u),
            f.updateCookie(r, e, i));
        } else e instanceof X && ((e.creation = e.lastAccessed = u), f.putCookie(e, i));
      }),
      i.promise
    );
  }
  ...
  getCookies(e, t, n) {
    typeof t == `function` ? ((n = t), (t = un)) : t === void 0 && (t = un);
    let r = G(n),
      i = r.callback,
      a;
    try {
      (typeof e == `string` && K(wt(e), i, e),
        (a = fn(e)),
        K(Dt(t), i, xt(t)),
        K(typeof i == `function`, i));
    } catch (e) {
      return r.reject(e);
    }
    let o = J(a.hostname),
      s = a.pathname || `/`,
      c = cn(e, this.allowSecureOnLocal),
      l = 0;
    if (t.sameSiteContext) {
      let e = pn(t.sameSiteContext);
      if (e == null || ((l = X.sameSiteLevel[e]), !l)) return r.reject(Error(dn));
    }
    let u = t.http ?? !0,
      d = Date.now(),
      f = t.expire ?? !0,
    ...
    function h(e) {
      ...
      } else if (!tn(o ?? void 0, e.domain ?? void 0, !1)) return !1;
      if (
        (!p && typeof e.path == `string` && !dt(s, e.path)) ||
        (e.secure && !c) ||
        (e.httpOnly && !u)
      )
        return !1;
        ...
        if (
          ((t =
            e.sameSite === `lax`
              ? X.sameSiteLevel.lax
              : e.sameSite === `strict`
                ? X.sameSiteLevel.strict
                : X.sameSiteLevel.none),
          t > l)
        )
          return !1;
      }
      let t = e.expiryTime();
      return f && t != null && t <= d
        ? (m.removeCookie(e.domain, e.path, e.key, () => {}), !1)
        : !0;
    }
    return (
      m.findCookies(o, p ? null : s, this.allowSpecialUseDomain, (e, n) => {
        if (e) {
          i(e);
          return;
        }
        ...
        ((n = n.filter(h)), `sort` in t && t.sort !== !1 && (n = n.sort(Qt)));
        let r = new Date();
  ...
  getCookieStringSync(e, t) {
    return (
      this.callSync(
        t ? this.getCookieString.bind(this, e, t) : this.getCookieString.bind(this, e),
      ) ?? ``
    );
  }
  ...
  serialize(e) {
    let t = G(e),
      n = this.store.constructor.name;
    Dt(n) && (n = null);
    let r = {
      version: `tough-cookie@${kt}`,
      storeType: n,
      rejectPublicSuffixes: this.rejectPublicSuffixes,
      enableLooseMode: this.enableLooseMode,
      allowSpecialUseDomain: this.allowSpecialUseDomain,
      prefixSecurity: gn(this.prefixSecurity),
      cookies: [],
    };
    return typeof this.store.getAllCookies == `function`
      ? (this.store.getAllCookies((e, n) => {
          if (e) {
            t.callback(e);
            return;
          }
  ...
  _importCookies(e, t) {
    let n;
    if (
      (e && typeof e == `object` && St(`cookies`, e) && Array.isArray(e.cookies) && (n = e.cookies),
      !n)
    ) {
      t(Error(`serialized jar has no cookies array`), void 0);
      return;
    }
    n = n.slice();
    let r = (e) => {
  ...
  cloneSync(e) {
    ...
    if (!e.synchronous)
      throw Error(`CookieJar clone destination store is not synchronous; use async API instead.`);
  ...
  removeAllCookies(e) {
    let t = G(e),
      n = t.callback,
      r = this.store;
    return typeof r.removeAllCookies == `function` &&
      r.removeAllCookies !== _t.prototype.removeAllCookies
      ? (r.removeAllCookies(n), t.promise)
      : (r.getAllCookies((e, t) => {
          if (e) {
            n(e);
            return;
  ...
  static deserialize(t, n, r) {
    ...
    let o = (e) => (a && typeof a == `object` && St(e, a) ? a[e] : void 0),
      s = (e) => {
        let t = o(e);
  ...
  static deserializeSync(t, n) {
    let r = typeof t == `string` ? JSON.parse(t) : t,
      i = (e) => (r && typeof r == `object` && St(e, r) ? r[e] : void 0),
      a = (e) => {
        let t = i(e);
        return typeof t == `boolean` ? t : void 0;
      },
...
var yn = new (class {
    ...
    constructor() {
      (fe() ||
        ...
        (this.#n = new Ct()),
        (this.#n.idx = this.getCookieStoreIndex()),
        (this.#t = new _n(this.#n)));
    }
    getCookies(e) {
      return this.#t.getCookiesSync(e);
    }
    async setCookie(e, t) {
      (await this.#t.setCookie(e, t), this.persist());
    }
    getCookieStoreIndex() {
      ...
      for (let e of t) {
        ...
        t != null &&
          t.domain != null &&
          t.path != null &&
          ((n[t.domain] ||= {}), (n[t.domain][t.path] ||= {}), (n[t.domain][t.path][t.key] = t));
      }
      return n;
    }
    persist() {
      if (typeof localStorage > `u` || typeof localStorage.setItem != `function`) return;
      let e = [],
        { idx: t } = this.#n;
      for (let n in t) for (let r in t[n]) for (let i in t[n][r]) e.push(t[n][r][i].toJSON());
  ...
  En = (e, t) =>
    function () {
      return (t || (0, e[Cn(e)[0]])((t = { exports: {} }).exports, t), t.exports);
    },
  Dn = (e, t, n, r) => {
    if ((t && typeof t == `object`) || typeof t == `function`)
      for (let i of Cn(t))
        !Tn.call(e, i) &&
          i !== n &&
          xn(e, i, { get: () => t[i], enumerable: !(r = Sn(t, i)) || r.enumerable });
    return e;
  },
  On = ((e, t, n) => (
    (n = e == null ? {} : bn(wn(e))),
    Dn(t || !e || !e.__esModule ? xn(n, `default`, { value: e, enumerable: !0 }) : n, e)
  ))(
    En({
      "node_modules/set-cookie-parser/lib/set-cookie.js"(e, t) {
        ...
        function i(e, t) {
          ...
          try {
            c = t.decodeValues ? decodeURIComponent(c) : c;
          } catch (e) {
            console.error(
          ...
          return (
            i.forEach(function (e) {
              var t = e.split(`=`),
                ...
                r = t.join(`=`);
              n === `expires`
                ? (l.expires = new Date(r))
                : n === `max-age`
                  ? (l.maxAge = parseInt(r, 10))
                  : n === `secure`
                    ? (l.secure = !0)
                    : n === `httponly`
                      ? (l.httpOnly = !0)
        ...
        function a(e) {
          var t = ``,
            ...
            r = e.split(`=`);
          return (
            r.length > 1 ? ((t = r.shift()), (n = r.join(`=`))) : (n = e), { name: t, value: n }
          );
        }
        function o(e, t) {
              ...
              var a =
                e.headers[
                  Object.keys(e.headers).find(function (e) {
                    return e.toLowerCase() === `set-cookie`;
                  })
                ];
              (!a &&
                e.headers.cookie &&
          ...
          return (
            ...
            (t = t ? Object.assign({}, n, t) : n),
            t.map
              ? e.filter(r).reduce(function (e, n) {
                  var r = i(n, t);
                  return ((e[r.name] = r), e);
                }, {})
            ...
            for (r = n, s = !1; c(); )
              if (((i = e.charAt(n)), i === `,`)) {
                ...
                n < e.length && e.charAt(n) === `=`
                  ? ((s = !0), (n = o), t.push(e.substring(r, a)), (r = n))
                  : (n = a + 1);
              } else n += 1;
        ...
        ((t.exports = o),
          ...
          (t.exports.splitCookiesString = s));
      },
    })(),
  ),
  kn = /[^a-z0-9\-#$%&'*+.^_`|~]/i;
function An(e) {
  if (kn.test(e) || e.trim() === ``) throw TypeError(`Invalid character in header field name`);
...
function In(e) {
  ...
  for (let t = 0; t < e.length; t++) {
    let n = e.charCodeAt(t);
    if (n === 0 || n === 10 || n === 13) return !1;
  }
  return !0;
}
var Z = Symbol(`normalizedHeaders`),
  Ln = Symbol(`rawHeaderNames`),
  Rn = `, `,
  zn,
  Bn,
  Vn,
  Hn = class e {
    constructor(t) {
      ((this[zn] = {}),
        ...
        t instanceof e ||
        (globalThis.Headers !== void 0 && t instanceof globalThis.Headers)
          ? t.forEach((e, t) => {
              this.append(t, e);
            }, this)
          : Array.isArray(t)
            ? t.forEach(([e, t]) => {
                this.append(e, Array.isArray(t) ? t.join(Rn) : t);
              })
            : t &&
              Object.getOwnPropertyNames(t).forEach((e) => {
                let n = t[e];
                this.append(e, Array.isArray(n) ? n.join(Rn) : n);
              }));
    }
    [((zn = Z), (Bn = Ln), (Vn = Symbol.toStringTag), Symbol.iterator)]() {
      return this.entries();
    }
    *keys() {
    ...
    *entries() {
      let e = Object.keys(this[Z]).sort((e, t) => e.localeCompare(t));
      for (let t of e)
        if (t === `set-cookie`) for (let e of this.getSetCookie()) yield [t, e];
        else yield [t, this.get(t)];
    }
    has(e) {
      if (!Pn(e)) throw TypeError(`Invalid header name "${e}"`);
      return this[Z].hasOwnProperty(An(e));
    }
    get(e) {
      if (!Pn(e)) throw TypeError(`Invalid header name "${e}"`);
      return this[Z][An(e)] ?? null;
    }
    set(e, t) {
      if (!Pn(e) || !In(t)) return;
      let n = An(e),
        r = Nn(t);
      ((this[Z][n] = Nn(r)), this[Ln].set(n, e));
    }
    append(e, t) {
      if (!Pn(e) || !In(t)) return;
      let n = An(e),
        r = Nn(t),
        i = this.has(n) ? `${this.get(n)}, ${r}` : r;
      this.set(e, i);
    }
    delete(e) {
      if (!Pn(e) || !this.has(e)) return;
      let t = An(e);
      (delete this[Z][t], this[Ln].delete(t));
    }
    forEach(e, t) {
    ...
    getSetCookie() {
      ...
      return e === null ? [] : e === `` ? [``] : (0, On.splitCookiesString)(e);
    }
  },
  { message: Un } = D,
  Wn = Symbol(`kSetCookie`);
function Q(e = {}) {
  let t = e?.status || 200,
    n = e?.statusText || Un[t] || ``,
    r = new Headers(e?.headers);
  return { ...e, headers: r, status: t, statusText: n };
}
function Gn(e, t) {
  t.type && Object.defineProperty(e, `type`, { value: t.type, enumerable: !0, writable: !1 });
  let n = t.headers.get(`set-cookie`);
  if (
    n &&
    (Object.defineProperty(e, Wn, { value: n, enumerable: !1, writable: !1 }),
    typeof document < `u`)
  ) {
    let e = Hn.prototype.getSetCookie.call(t.headers);
    for (let t of e) document.cookie = t;
  }
  return e;
}
var Kn = Symbol(`bodyType`),
  $ = Symbol.for(`kDefaultContentType`),
  qn = class e extends de {
    [Kn] = null;
    constructor(e, t) {
      let n = Q(t);
      (super(e, n), Gn(this, n));
    ...
    static text(t, n) {
      let r = Q(n),
        i = r.headers.has(`Content-Type`);
      (i || r.headers.set(`Content-Type`, `text/plain`),
        r.headers.has(`Content-Length`) ||
          r.headers.set(`Content-Length`, t ? new Blob([t]).size.toString() : `0`));
      let a = new e(t, r);
      return (i || Object.defineProperty(a, $, { value: !0, enumerable: !1 }), a);
    }
    static json(t, n) {
      let r = Q(n),
        i = r.headers.has(`Content-Type`);
      i || r.headers.set(`Content-Type`, `application/json`);
      let a = JSON.stringify(t);
      r.headers.has(`Content-Length`) ||
        r.headers.set(`Content-Length`, a ? new Blob([a]).size.toString() : `0`);
      let o = new e(a, r);
      return (i || Object.defineProperty(o, $, { value: !0, enumerable: !1 }), o);
    }
    static xml(t, n) {
      let r = Q(n),
        i = r.headers.has(`Content-Type`);
      i || r.headers.set(`Content-Type`, `text/xml`);
      let a = new e(t, r);
      return (i || Object.defineProperty(a, $, { value: !0, enumerable: !1 }), a);
    }
    static html(t, n) {
      let r = Q(n),
        i = r.headers.has(`Content-Type`);
      i || r.headers.set(`Content-Type`, `text/html`);
      let a = new e(t, r);
      return (i || Object.defineProperty(a, $, { value: !0, enumerable: !1 }), a);
    }
    static arrayBuffer(t, n) {
      let r = Q(n),
        i = r.headers.has(`Content-Type`);
      (i || r.headers.set(`Content-Type`, `application/octet-stream`),
        t &&
          !r.headers.has(`Content-Length`) &&
          r.headers.set(`Content-Length`, t.byteLength.toString()));
      let a = new e(t, r);
      return (i || Object.defineProperty(a, $, { value: !0, enumerable: !1 }), a);
    }
    static formData(t, n) {
  ...
  Jn = Symbol(`kConnect`),
  Yn = Symbol(`kAutoConnect`),
  Xn = async ({ request: e, requestId: t, handlers: n, resolutionContext: r }) => {
    let i = null,
      a = null;
    for (let o of n)
      if (
        ((a = await o.run({ request: e, requestId: t, resolutionContext: r })),
        a !== null && (i = o),
        a?.response)
      )
        break;
    return i ? { handler: i, parsedResult: a?.parsedResult, response: a?.response } : null;
  };
function Zn(e) {
  let t = new URL(e.url);
...
//# sourceMappingURL=isCommonAssetRequest-Bwl7cir4.js.map
