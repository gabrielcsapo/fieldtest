import { f as e, m as t, p as n } from "./src-CL-PUynl.js";
function r(e) {
...
(n(`countPending()`, () => {
  (t(`counts only non-done tasks`, () => {
    e(r(o)).toBe(2);
  }),
    t(`returns 0 when all done`, () => {
      e(r(o.map((e) => ({ ...e, done: !0 })))).toBe(0);
    }),
    t(`returns full count when none done`, () => {
