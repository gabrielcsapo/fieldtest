...
import { t as o } from "./Card-BdJMjhXl.js";
var s = a();
r(`Card`, () => {
  (t(`renders title and description`, async () => {
    ...
    t(`renders action button and fires callback`, async () => {
      let t = !1,
        { getByRole: r } = await i(
          (0, s.jsx)(o, {
            title: `Delete item`,
    ...
    t(`shows danger variant styles`, async () => {
      await i(
        (0, s.jsx)(o, {
          title: `Warning`,
    ...
    t(`renders without an action button`, async () => {
...
//# sourceMappingURL=Card.test-Mz_3ccsy.js.map
