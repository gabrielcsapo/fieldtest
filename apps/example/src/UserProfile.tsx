...
export function UserProfile({ userId }: Props) {
  ...
  if (error) {
    return (
      <div style={{ padding: 20, background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: 8, color: '#fca5a5', fontSize: 14 }}>
  ...
  return (
    <div style={{
      ...
      border: '1px solid #2a2a36', borderRadius: 10, minWidth: 260,
    }}>
      <div style={{
      ...
      <span style={{
        fontSize: 11, fontWeight: 600, color: roleColor[user.role],
